# Prompt para Victor — Presentación "Costos de Mano de Obra"
...
El tema de esta presentación es **Costos de Mano de Obra**, apoyada en el
sistema **Ridder**, que ayuda a los agricultores a controlar los costos de
personal, supervisar la calidad de la cosecha y pagar a los trabajadores de
forma justa según su desempeño real.
...
<title>Costos de Mano de Obra · OPEX · GHVeggies</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@600;700;800&family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
...
<body>
  ...
  <div class="slides-track" id="track">
    ...
    <section class="slide" data-slide>
      <div class="slide-in">
        <p class="eyebrow text-fresh-green">Sistema Ridder</p>
        <h1 class="font-display text-5xl md:text-6xl font-extrabold mt-4">Costos de Mano de Obra</h1>
      </div>
    </section>
...
- **Nombra las imágenes con un consecutivo**: `ridder1.jpg`, `ridder2.jpg`,
  `ridder3.jpg`... en el orden en que aparecen en la presentación. Dile
...
- Referencia siempre las imágenes con **ruta relativa**, así:
  `<img src="./images/ridder1.jpg" alt="...">`.
...
1. **Portada** — "Costos de Mano de Obra" / kicker "Sistema Ridder"
2. **El reto** — por qué controlar el costo de mano de obra en campo importa
3. **Qué es Ridder y cómo se usa hoy** en la operación
4. **Cómo medimos** — productividad, calidad de cosecha, pago justo por
   desempeño real
5. **Datos y resultados** (aquí van tus métricas reales — no inventes cifras)
6. **Antes vs. después** de implementar el control con Ridder
7. **Próximos pasos**
8. **Cierre**
